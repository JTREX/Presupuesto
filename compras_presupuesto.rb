...
#Compra máxima.
#Y regresa cuántos 
#gastos del Array son menores que 30
#y están entre la compra mínima y compra máxima.

def total_shopping_budget(arr,min,max)

  arr.select.count{|item| item >= min && item <= max}
